...
def read_last_line_all(predictions_file_path, sources):
    """Function to read the last row of the file when predicting sound sources,
...
def plot_predictions_all(predictions_file_path, sound_classes, palette_PE):
    ...
    while True:
        (
            ...
            PE_predictions,
            timestamp,
        ) = read_last_line_all(predictions_file_path, sound_classes)
