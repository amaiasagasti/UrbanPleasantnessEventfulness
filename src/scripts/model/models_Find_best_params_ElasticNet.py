...
def main(data_path, data_foldFs_path, saving_folder):
    ...
    input_dicts = [
        # region ARAUS
        {
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_noM_noNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_noM_stdMeanNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_noM_minMaxnNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M1_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 5,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M5_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 10,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M10_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M20_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M20_stdMeanNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_ARAUS_M20_minMaxNorm.txt",
        },
        # endregion
        # region Freesound
        {
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_noM_noNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_noM_stdMeanNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_noM_minMaxnNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_M1_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 5,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_M5_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 10,
            ...
            "predict": "E",
            "features": Freesound_features,
            "name": saving_folder + "E_EN_Freesound_M10_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_M20_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_M20_stdMeanNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_Freesound_M20_minMaxNorm.txt",
        },
        # endregion
        # region CLAP
        {
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_noM_noNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_noM_stdMeanNorm.txt",
        },
        {
            "maskers_active": False,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_noM_minMaxnNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 1,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M1_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 5,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M5_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 10,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M10_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M20_noNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M20_stdMeanNorm.txt",
        },
        {
            "maskers_active": True,
            "masker_gain": 20,
            ...
            "df_foldFs": df_foldFs,
            "predict": "E",
            "name": saving_folder + "E_EN_clap_M20_minMaxNorm.txt",
        },
        # endregion
    ]
    for input_dict in input_dicts:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Try different parameter combinations for an Elastic Net model for the prediction of Pleasantness and Eventfulness. Saves data in txt file."
    )
    parser.add_argument(
        "--data_path",
        type=str,
