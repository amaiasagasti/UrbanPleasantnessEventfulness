...
def run_variations_model(input_dict):
    ...
    with open(input_dict["name"], "a") as f:
        ...
        model = MLPRegressor(random_state=1, max_iter=500, solver="lbfgs")
...
input_dict = {
    ...
    "name": saving_folder + "MLPR_ARAUS_noM_noNorm.txt",
}
...
input_dict = {
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_noM_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": False,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_noM_minMaxnNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M1_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M5_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M10_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M20_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M10_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_ARAUS,
    "features": ARAUS_features,
    "name": saving_folder + "MLPR_ARAUS_M10_minMaxNorm.txt",
}
run_variations_model(input_dict)
# Freesound
input_dict = {
    ...
    "name": saving_folder + "MLPR_Freesound_noM_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": False,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_noM_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": False,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_noM_minMaxnNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M1_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M5_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M10_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M20_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M10_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_Freesound,
    "features": Freesound_features,
    "name": saving_folder + "MLPR_Freesound_M10_minMaxNorm.txt",
}
run_variations_model(input_dict)
# CLAP
input_dict = {
    ...
    "name": saving_folder + "MLPR_clap_noM_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": False,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_noM_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": False,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_noM_minMaxnNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M1_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M5_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M10_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M20_noNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M10_stdMeanNorm.txt",
}
run_variations_model(input_dict)
input_dict = {
    "maskers_active": True,
    ...
    "dataframe": df_clap,
    "features": clap_features,
    "name": saving_folder + "MLPR_clap_M10_minMaxNorm.txt",
}
run_variations_model(input_dict)
#####################################################################################
